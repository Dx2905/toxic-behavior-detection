...
training_args = TrainingArguments(
    output_dir="models/results_bart",
...
def compute_metrics(eval_pred):
    ...
    logits = logits[0]  # 🔥 First element
    logits = logits[:, :6]  # 🔥 Take only first 6 outputs (for the 6 labels)
...
# Correct safe path
model_save_path = os.path.join(os.getcwd(), "models", "saved_model_bart_toxic")
